...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th><a href="javascript:listTable.sort('msg_id'); "><?php echo $this->_var['lang']['msg_id']; ?></a><?php echo $this->_var['sort_msg_id']; ?></th>
...
?>
  <tr>
    <td align="center"><?php echo $this->_var['msg']['msg_id']; ?></td>
