...
<div id="search"  class="clearfix">
  ...
  <form id="searchForm" name="searchForm" method="get" action="search.php" onSubmit="return checkSearchForm()" class="f_r"  style="_position:relative; top:5px;">
   <select name="category" id="category" class="B_input">
      ...
      <option value="6" >虚拟主机</option><option value="9" >&nbsp;&nbsp;&nbsp;&nbsp;商务主机</option><option value="7" >&nbsp;&nbsp;&nbsp;&nbsp;标准主机</option><option value="8" >&nbsp;&nbsp;&nbsp;&nbsp;推荐主机</option><option value="1" >建站套餐</option><option value="3" >&nbsp;&nbsp;&nbsp;&nbsp;低价打折</option><option value="4" >&nbsp;&nbsp;&nbsp;&nbsp;精品套餐</option><option value="5" >&nbsp;&nbsp;&nbsp;&nbsp;标准套餐</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;商务套餐</option><option value="12" >域名注册</option><option value="14" >&nbsp;&nbsp;&nbsp;&nbsp;域名注册</option>    </select>
