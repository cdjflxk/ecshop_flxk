...
(11, '', 200, 123, '', '', 1, '域名', '星空软件', 2, '123', '', 5, '星空软件');

-- --------------------------------------------------------

--
-- 表的结构 `xk_product_template`
--

DROP TABLE IF EXISTS `xk_product_template`;
CREATE TABLE IF NOT EXISTS `xk_product_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `market_price` int(11) NOT NULL,
  `discount` int(11) NOT NULL,
  ...
  `free_gift` varchar(50) NOT NULL,
  `is_sale` int(1) NOT NULL DEFAULT '0',
  `top_categroy` varchar(20) NOT NULL DEFAULT '模板',
  `second_category` varchar(20) NOT NULL,
  `order` int(11) NOT NULL,
  `short_description` varchar(100) NOT NULL,
  `image` varchar(100) NOT NULL,
...
--
-- 转存表中的数据 `xk_product_template`
--

INSERT INTO `xk_product_template` (`id`, `name`, `market_price`, `discount`, `type`, `free_gift`, `is_sale`, `top_categroy`, `second_category`, `order`, `short_description`, `image`, `demo_url`, `third_category`) VALUES
(13, '机械_01', 300, 1, 'jixie_01', '', 1, '域名', '星空软件', 1, '', '', 'http://gyzp11a22.site3.idccenter.net/gyzp11a22/wwwroot/index2.html', '');
...
INSERT INTO `xk_user` (`id`, `name`, `pass`, `role_id`, `realname`, `address`, `telephone`, `mobile`, `email`, `qq`) VALUES
(1, 'admin', 'admin', 1, '', '', '', '', '', ''),
(2, 'admin', 'adminm', 2, '', '', '', '', '', '');
